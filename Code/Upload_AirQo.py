...
# ## PM10 Plots 
# ## PM10 RAW Data
# plt.scatter(list_airqo_g5126_timestamp_raw, list_airqo_g5126_PM10_raw, alpha=0.5, marker="x")
# #plt.ylim(0, 1000)
# plt.xticks(rotation=45, ha='right')
# plt.xlabel("Date")
...
## PM10 Plots 
## PM10 RAW Data for AirQo G5113
plt.scatter(list_airqo_g5113_timestamp_raw, list_airqo_g5113_PM10_raw, alpha=0.5, marker="x")
#plt.ylim(0, 1000)
plt.xticks(rotation=45, ha='right')
plt.xlabel("Date")
plt.ylabel("PM$_{10}$ ($\mu$g/m$^3$)")
